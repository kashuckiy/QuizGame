...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Установлюємо картинку в діалогове вікно початок*/
        ImageView previewimg = (ImageView)dialog.findViewById(R.id.previewimg);
        previewimg.setImageResource(R.drawable.previewimgtwo);
        /*Установлюємо картинку в діалогове вікно кінець*/

        /*Встановлюємо описання завдання початок*/
        TextView textdescription = (TextView)dialog.findViewById(R.id.textdescription);
        textdescription.setText(R.string.leveltwo);
        /*Встановлюємо описання завдання кінець*/
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level2.this, GameLevels.class);//Створення наміру перехода
        ...
        img_left.setImageResource(array.images2[numLeft]);//Достаємо з масива картинку
        text_left.setText(array.texts2[numLeft]);//Достаємо з масива текст
        ...
        img_right.setImageResource(array.images2[numRight]);//Достаємо з масива картинку
        text_right.setText(array.texts2[numRight]);//Достаємо з масива текст
